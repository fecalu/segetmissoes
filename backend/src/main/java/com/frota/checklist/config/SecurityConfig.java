    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/admin/alocacoes", "/api/admin/alocacoes/*/historico").hasAuthority("ALOCACAO_CONSULTAR")
                        .requestMatchers(HttpMethod.POST, "/api/admin/alocacoes").hasAuthority("ALOCACAO_GERIR")
                        .requestMatchers(HttpMethod.PUT, "/api/admin/alocacoes/*/dados").hasAuthority("ALOCACAO_GERIR")
                        .requestMatchers(HttpMethod.PATCH, "/api/admin/alocacoes/*/veiculo", "/api/admin/alocacoes/*/responsavel", "/api/admin/alocacoes/*/encerrar").hasAuthority("ALOCACAO_GERIR")

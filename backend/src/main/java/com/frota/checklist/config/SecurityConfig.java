    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/admin/veiculos/*/imagem").hasAuthority("VEICULO_GERIR")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/admin/configuracoes/rotulos-status-veiculo", "/api/admin/configuracoes/sugestoes-missao", "/api/admin/configuracoes/locais-operacionais").hasAuthority("FROTA_CONSULTAR")
                        .requestMatchers(HttpMethod.PUT, "/api/admin/configuracoes/rotulos-status-veiculo", "/api/admin/configuracoes/sugestoes-missao", "/api/admin/configuracoes/locais-operacionais").hasAuthority("CONFIGURACAO_GERIR")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/admin/veiculos/*/imagem").hasAuthority("VEICULO_GERIR")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/vistorias-completas/**").hasAnyAuthority("ROLE_MOTORISTA", "VISTORIA_REGISTRAR")
